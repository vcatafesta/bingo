...
Proc SetaClasse()
*****************
oMenu:StatusSup := "Macrosoft BINGO 2000 Versao 2.2.16 - 08/07/2004"
oMenu:StatusInf := "F2³F3³F10³TAB³DEL³INS³ESC³PGUP³PGDN³*³"
oMenu:NomeFirma := 'MACROSOFT SISTEMAS DE INFORMATICA LTDA'
...
AADD( AtPrompt, {"Impressao",   {"1 Premio","2 Premio","3 Premio Versao 1", "3 Premio Versao 2","3 Premio Versao 3",'1 Premio Versao 4','2 Premios Versao 4','3 Premios Versao 4','3 Premios Versao 5'}})
...
WHILE OK
   ...
   @ 12, 11 Say "Cartela Inicial.." Get cIni  Pict "####" Valid AchaCartela( @cIni )
   @ 13, 11 Say "Cartela Final...." Get cFim  Pict "####" Valid AchaCartela( @cFim ) .AND. IF( cFim < cIni, ( ErrorBeep(), Alerta("Erro: Cartela tem que ser maior ou igual Inicial"), FALSO ), OK )
   @ 14, 11 Say "Data............." Get cData Pict "@!"   Valid IF( Empty( cData ), ( ErrorBeep(), Alerta("Erro: Campo nao pode ser vazio."), FALSO ), OK )
   Read
   IF LastKey() = ESC
      ResTela( cScreen )
      Return
