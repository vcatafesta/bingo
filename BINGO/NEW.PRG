...
Use Bingo New
// Normal
Inde on Numero To Bingo1
// Primeira Carreira Horizontal
Inde On Left( Numero, 02 ) + SubStr( Numero,16,2) + SubStr( Numero, 31, 2 ) + SubStr( Numero, 46,2 ) + SubStr( Numero, 61, 2 ) To Bingo2 Unique
// Segunda Carreira Horizontal
Inde On SubStr( Numero, 04,2) + SubStr( Numero,19,2) + SubStr( Numero, 34, 2 ) + SubStr( Numero, 49,2 ) + SubStr( Numero, 64, 2 ) To Bingo3 Unique
// Terceira Carreira Horizontal
Inde On SubStr( Numero, 07,2) + SubStr( Numero,22,2) + SubStr( Numero, 37, 2 ) + SubStr( Numero, 52,2 ) + SubStr( Numero, 67, 2 ) To Bingo4 Unique
// Quarta Carreira Horizontal
Inde On SubStr( Numero, 10,2) + SubStr( Numero,25,2) + SubStr( Numero, 40, 2 ) + SubStr( Numero, 55,2 ) + SubStr( Numero, 70, 2 ) To Bingo5 Unique
// Quinta Carreira Horizontal
Inde On SubStr( Numero, 13,2) + SubStr( Numero,28,2) + SubStr( Numero, 43, 2 ) + SubStr( Numero, 58,2 ) + SubStr( Numero, 73, 2 ) To Bingo6 Unique
Bingo->(DbCloseArea())
Use Bingo New
   DbSetIndex("Bingo1")
   DbSetIndex("Bingo2")
